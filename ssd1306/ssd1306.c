...
void OLED_init(void)
{
    ...
    for (i = 0; i < OLED_CMD_NUMBER; i++) {
        ssd1306_WriteCommand(OLED_init_cmd[i]);
    }
}
...
void ssd1306_Init(void)
{
    ...
    ssd1306_WriteCommand(0x80); //Set Memory Addressing Mode
    ssd1306_WriteCommand(0xA8); //Set Memory Addressing Mode
    ssd1306_WriteCommand(0x3F); //Set Memory Addressing Mode

    ssd1306_WriteCommand(0xD3); //Set Memory Addressing Mode
    ssd1306_WriteCommand(0x00); //Set Memory Addressing Mode
    ssd1306_WriteCommand(0x40); //Set Memory Addressing Mode
    ssd1306_WriteCommand(0x8D); //Set Memory Addressing Mode
    ssd1306_WriteCommand(0x10); //Set Memory Addressing Mode

    ssd1306_WriteCommand(0x20); //Set Memory Addressing Mode
    ssd1306_WriteCommand(0x02); //Set Memory Addressing Mode
    ssd1306_WriteCommand(0xA1); //Set Memory Addressing Mode
    ssd1306_WriteCommand(0xC8); //Set Memory Addressing Mode
    ssd1306_WriteCommand(0xDA); //Set Memory Addressing Mode

    ssd1306_WriteCommand(0x12); //Set Memory Addressing Mode
    ssd1306_WriteCommand(0x81); //Set Memory Addressing Mode
    ssd1306_WriteCommand(0xF0); //Set Memory Addressing Mode
    ssd1306_WriteCommand(0xD9); //Set Memory Addressing Mode
    ssd1306_WriteCommand(0x71); //Set Memory Addressing Mode

    ssd1306_WriteCommand(0xDB); //Set Memory Addressing Mode
    ssd1306_WriteCommand(0x00); //Set Memory Addressing Mode
    ssd1306_WriteCommand(0xA4); //Set Memory Addressing Mode
    ssd1306_WriteCommand(0xA6); //Set Memory Addressing Mode
 ...
 */
void ssd1306_DrawArcWithRadiusLine(uint8_t x,
                                   uint8_t y,
                                   uint8_t radius,
...
{
    column = column + 0;
    ssd1306_WriteCommand(0x10 | (column >> 4));    //�����е�ַ��λ
    ssd1306_WriteCommand(0x00 | (column & 0x0f));   //�����е�ַ��λ
